...
import 'package:bibliasacra/fonts/constants/constants.dart';
import 'package:bibliasacra/fonts/constants/translations.dart';
import 'package:bibliasacra/fonts/models/picker_font.dart';
import 'package:bibliasacra/fonts/ui/font_picker_ui.dart';
...
class FontPicker extends StatefulWidget {
  ...
  const FontPicker({
    ...
    this.recentsCount = 10,
    required this.onFontChanged,
    this.initialFontFamily,
    this.lang = "en", required this.googleFonts,
  });

  @override
  FontPickerState createState() => FontPickerState();
}
